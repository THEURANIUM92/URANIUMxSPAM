...
async def start_uranium():
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await adk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await edk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await sid(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await shy(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await aan(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await ake(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await eel(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await khu(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await shi(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await dav(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await raj(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
            await put(functions.channels.JoinChannelRequest(channel=" @URANIUM_FIGHTERS"))
